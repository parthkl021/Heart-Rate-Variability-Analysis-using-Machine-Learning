...
for i in range(1, 54):
    ...
    with open(filename, 'r') as file:
        ...
        if 'Gender: M' in file_contents:
            male_list.append(i)
        elif 'Gender: F' in file_contents:
            female_list.append(i)

male = male_list + [13, 19]
female = female_list + [15]
             
male_model = train_and_evaluate_for_group(male, female,0.1)
female_model = train_and_evaluate_for_group(female, male,0.1)
